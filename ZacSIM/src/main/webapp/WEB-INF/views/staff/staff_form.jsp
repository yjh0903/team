				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="box box-primary">
							...
							<!-- /.box-header -->
							<!-- form start -->
							<form id="addForm" role="form" action="${pageContext.request.contextPath}/staff/staff_pro" method="post">
								<div class="box-body">
									...
									<div>
										<input type="text" id="staff_postcode"  name="staff_postcode" placeholder="우편번호">
