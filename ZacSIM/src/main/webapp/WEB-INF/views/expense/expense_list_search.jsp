				...
				<div class="row">
					<div class="col-md-12">
						<div class="box box-danger">
							...
							<form action="${pageContext.request.contextPath}/expense/expense_list_search" method="post">
								<div class="box-body">
												...
												<tr>
													...
													<td>
														<ul class="searchDate">
															<li>
																<span class="chkbox2"> 
																	<input type="radio" name="expense_date" id="dateType1" onclick="setSearchDate('0d')" /> 
																	<label for="dateType1">당일</label>				
																</span>
															</li>
															<li>
																<span class="chkbox2"> 
																	<input type="radio" name="expense_date" id="dateType2" onclick="setSearchDate('3d')" /> 
																	<label for="dateType2">3일</label>
																</span>
															</li>
															<li>
																<span class="chkbox2"> 
																	<input type="radio" name="expense_date" id="dateType3" onclick="setSearchDate('1w')" /> 
																	<label for="dateType3">1주</label>
																</span>
															</li>
															<li>
																<span class="chkbox2"> 
																	<input type="radio" name="expense_date" id="dateType4" onclick="setSearchDate('2w')" /> 
																	<label for="dateType4">2주</label>
																</span>
															</li>
															<li>
																<span class="chkbox2"> 
																	<input type="radio" name="expense_date" id="dateType5" onclick="setSearchDate('1m')" /> 
																	<label for="dateType5">1개월</label>
																</span>
															</li>
															<li>
																<span class="chkbox2"> 
																	<input type="radio" name="expense_date" id="dateType6" onclick="setSearchDate('3m')" /> 
																	<label for="dateType6">3개월</label>
																</span>
															</li>
															<li>
																<span class="chkbox2"> 
																	<input type="radio" name="expense_date" id="dateType7" onclick="setSearchDate('6m')" /> 
